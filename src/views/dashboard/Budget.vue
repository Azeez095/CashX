    ...
    <div class="flex flex-col mb-4 gap-6 lg:gap-10 text-md md:text-base">
      ...
      <div class="flex flex-col justify-between gap-4">
        <div
          ...
          :key="index"
          class="bg-gray-200 border border-custom-light mx-2 mb-1 max-w-full p-2 md:p-8 grid grid-cols-3 lg:grid-cols-5 gap-4 justify-between items-center rounded-3xl transition-transform duration-300 hover:scale-105 hover:shadow-lg relative"
        >
