<template>
  <div
    class="bg-custom-dark min-h-screen hidden lg:block min-w-[350px] border-r border-r-[#E5E5E5]"
  >
    <div class="p-6 flex flex-col gap-10">
      <h1 class="sm:text-custom-light text-4xl text-center font-extrabold">
        CashX
      </h1>
      ...
      <div class="flex flex-col gap-5">
        <router-link
          to="/dashboard/financial-insight"
      ...
      <router-link
        ...
        class="py-4 px-5 w-full font-medium flex items-center gap-2 rounded-[30px] text-custom-light"
      >
        <AppBtn type="button" variant="secondary" class="w-full"
          >Log out</AppBtn
        >
      </router-link>
    </div>
  ...
  <div
    class="py-3 lg:hidden bg-white border-0 px-4 flex items-center justify-between sticky top-0 z-50"
  >
  ...
  <div
    v-if="isOpen"
    @click="toggleMenu"
    class="modal_overlay bg-custom-dark lg:hidden"
  >
    <div @click.stop.prevent class="h-screen relative w-[78%] bg-white">
      <div class="p-6 flex flex-col gap-10">
        ...
        <AppBtn type="button" variant="primary" class="w-full" @click="logout"
          >Log out</AppBtn
        >
      </div>
    </div>
